...
1. ArtStartPage            - contains the loose StartPage XAML file and creates a VSIX for deployment.
2. ArtStartPageControl     - creates a very simple WPF UserControl to add to the Start Page.
...
From the drop down, select "[Installed Extension] ArtStartPage".
